                  ...
                  <tbody>
                    {projects.data.map(project => (
                      <tr key={project.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <th className="px-3 text-gray-100 py-2 hover:underline text-nowrap">
                        ...
                        <td className="px-3 py-2">{project.createdBy?.name || 'N/A'}</td>
                        <td className="px-3 py-2">
                          ...
                          <Link href={route('project.destroy', project.id)} style={{ color: 'red' }} className="font-medium hover:underline mx-1"> Delete </Link>
                        </td>
                      </tr>
                    ))}
                  </tbody>
